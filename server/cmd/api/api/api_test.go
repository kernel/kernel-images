...
func TestApiService_StartRecording(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		svc, err := New(mgr, newMockFactory(), newTestUpstreamManager(), scaletozero.NewNoopController(), newMockNekoClient(t), newTestPipeline(), 0)
...
func newTestPipeline() *events.Pipeline {
