...
var swaggerSpec = []string{
	...
	"HrnAy4mqXpa3D1eGHuEQuQpFa+JBwbQiz55fkExwpoUc1Fzj1uOE+qzrYMu1EFsKU5HHx4/ts49lg6qu",
	"bEiUa5G3HsS/T9Nzc6aQ7lPuyj4Gj2h/vBmBvwj9QhQ8CYpfLfIQrM3gc9Ch3BcLy/oVHMFc1opvhdju",
	"C/0fQX+dwKca7gT0pSGjC/meMEDLbdVL3Mu7g3Yo9Pqe5PS6KO/PLK+3R7szPd9ORN+SYJyw7aOZ8FVC",
	"U6lVmDFPNcnMWW5upJ5IjMqO4dZWA9MsA//MlqGp7w1N0QZJpRil4UnLvgRG0xSkfe3dPmbiYnVcGLfv",
	"7oKbyvdgKQZ+C94jjTsJn/elZfenlgZvuydfRgzJW9PjF1EZELphIq7pC67sTf8d+RzTYVSgTNI8FVOa",
	"1qolIU2WxaSqUjakrHeD90fGYwlUWQJtlb/hCZlRbnqJAr17NE2JyIH7IjZxFWAatJvVSkXdl/obqEb1",
	"mcVptyZSgIJtISYax5D7yNeyxtH+5Nw0tNnx1pXQahBbVUEsqPK8zoFbN9myUbhIzLwVoXTQd2kPy71j",
	"mjAWOUQdVciM/MGSp+Sjgj8/jcc8oZo+JR99PaihAbv5fTzmf4zIZZMaS+NIq2aTgWQi8FFzCQp0mZDn",
	"+Ev9k9BWTSZcN+VYBH/JRKHqkn1JU2aj5LFuU1kTxJaLI8+lUdPNUmx1XWshn9Nc+Vd6/2DJHzbz7qmv",
	"9yghBraExH5jyppB9YJyckLowuUxYnUps1Bllm+aDjykrwEfxGWY61aC3RU+Js9Shq2cLV9LGl8FRrPP",
	"5muINa53RF7gGxo1HrZ5R1y04GXj+sppS/3XI8igQPB0RRTYJKb626Pt46ysHagwGNWQiAapsIRut/Bh",
	"Bu6lCqyU1RJQ7tEifP2UJ+TYpuMG1+ptKtuSFUYCUvdKo6WXLrXYwl7KpyGm5fNdVNeLejGzGYNkzI60",
	"kb5RA8LRoCZq2sbg9xtFl4YbbZl6WPH0Hcqul30SYISllMzGcGX/Oby8PBu6GKLh22BBuleQMOrSR2c4",
	"KNYmdHR+0JbChw3Q+IJ9HVkdqFz4qX3+4tLdPFQRVy330lCHo0cUjjN1ZA5EDZOyzD4ex0Uojg4blgUi",
	"7iuYrjnLTqfcybp6FnafX5HRze7UKcQV+D1erOlkC7w8x4b3jRc7S/29rL2jNUqU2C1+9gvXXYR54Mrr",
	"T1m28eYTCNag7IUN4v+6sYWFnP4CiEJ8lDgS1zwVNDHcNfnA8l610FtaKPnt/MKWHanlfdiXRxBdqqyQ",
	"WRVdqr8e2sK/m/85k7+xfJNqUL0nV3IOxnWZK4pLRrF6oR105E/hPwtAceAOYVd+qkkD9QNnYzmr9zvd",
	"Kxxcb+UKNlD3eyzLkSBh1QH8LdKlQ1ZdhJiD2hKa23IPvSqdbEGwmsrRB6XJgaaylrSU+ZAJ1H7NWIdr",
	"6XrM1xA2+U1po83PjGpprgj4QDQWl5hRZTRZP6Ez7Y95AvWfzN9U2qK4H1juXNk0XjBY4mucoNujIBuF",
	"4xVrXGVg9K2w1eBj922pcrsY1zMiP7H5AqT9V/lELVGZtcL5JEkyLTTR9ApIKvgc5GjMhxYTSj8l/zbY",
	"tkOQkwFxpT0MYiEhB/9+dHw8fHJ8TF79cKQOTUdXuqTZ8dGATGlKeWxUKdPzCDFADv598qTW1yKu2fUf",
	"A49P3+XJ8fB/NTp1lnkywF/LHg+Ph4/LHj0YqVHLBIdpqNVV6Wz/V1Ub24EqGtS+2SXjHypU8XxXqei4",
	"91Zi8a3j7f/PRKNubrsUj0Z+TXxFEycWm6KhfKt6W5mw8Tnwr+GE3U0nrN7r7hIUanm1x8C/QbL5EXTj",
	"OXP/Ok0HeyXZpExp1NNVL91Ur6rvd5h8m5RS7TpAKtX1LbWunm+QVjCHHTFv02u7tIHvcPdd3/zL0fcY",
	"MH4XVzcM0K7MHd8gnnAHaJzGqgDrmFkCTcpLd5CX3wBN3JV7O1bGybxKaMb/WrhZxBrC1s89dAkU/cHs",
	"xm+MWDCXsrzKNGycCqygn9RKOvdyd7ey9v2l5vWU8N675kytYvUXima4C+8x6C6j16txH2G1b7VgeYlh",
	"W3Si35WM1X98bQp0/9qKCkISWxslBXcgOC+ihEw4GWAzPEc9tVi8enBnxVdKjaSnekr1Zn9/FXPTxj3j",
	"XEowV0vQKbTb1C8fRF6g7lqjxNUnqZa6c5ESC4U7q0+CWCpLk3zroi5QsmTm9LU6O3jT5trSSxQNL8hv",
	"9kFeW2WJaVXZNjtJXW366mMOa928M9bYlfSTejXzWv2o8uKsxXZ8UC8JdIt6Pev4YU/C/o3lFVnXEPiX",
	"IXJaLwPWItEOvTvjygaC39U02scXY76ZMTabSBsW0TFvmUT7i4A5G+edMZe3qnQzFhbQNr2UR8hGZhh8",
	"OaY1f+WTiu7Wl2OunotMwaoIeHBW3W3AhWS5fz3HrQ1LfGEBb0NOwyG2GVb9DjfVC2/JC4+HexEXpw6G",
	"f3GR0SbXHrFx3S7TFQhHdY9s3Gccausdj+1xu2dJYdx28FXld5z9WUDo8YmKK68dODbW8+/eNXGb5K4r",
	"X34hYrObqRupXfkyPq9pYgito48e5J+aWTHdZJSK3FpGCjQ8OEuDszuUeFxne9hsagg8KusRhUko3zqi",
	"MP8FYWUD0LvGozaSXNBorynJxle9UH2hffeHqzuMhsOnVvBq614ODUSiN8Lgqruwiyz7qgPivkEytU+l",
	"tqHsCgFZsVtSrLnMrw8ywlJV2xg8n9eUL9oxfn5Gv/fr6skR/3pc78NxpP7wyXePH/ctE19b61nW2ufm",
	"LPNtc+Lf0hy7pzWjLJT2rR+jaJYyJ6ePh6xCtVIxD0Tut1x0Yu4eae+Rwy2CcO9Nr6NcL2gciVdVn4OP",
	"hoenmYk0FdfhyIPGi7u1h8/aaMYw87KWPZsRu3bCFHFLW8OY/afKLvPU9h6erWowcXHlXy6++6WYb3mU",
	"GcL65sK5zaKx9L+Z2jJIntLVNT5We+SKu25RdFhOmZZUrshF2du+yo++0BnmSVRvSSJqbjShc8q4sjfx",
	"qRTXCiSRBcfC5lxwkoqYpguh9NPvHz586JIEzagLqjAVSKGofpDTOTwYkAdu3Ae2JPQDN+SD8i0oX7vE",
	"PW3mM4/NiNXisIC0LiS3z0vVaw+HDCcOBNW+n9nT4T5udp25vlDCVmAdBqDBim4VcL/GIsHVFrAYxyWu",
	"3FJEgDgdg1iZhNzRf9F3j+Obie6t6lU5w5dK3KuvoI8Cqhrf0rX5KopDxyLLjJRQKx4vpOCiUL4WtEew",
	"yuk134jhS2x1ryjGKb4sjt0S+pCMn79wSaAubuka5H50f+Dd/Io162oFEf0zwwJNm+/l1chrVcJSky8K",
	"ltzmsrAXQs1uvsr6va9//ibjC4wowYRWfGjEqa39FCdBsQ+wkebe2GZ/Gaqz+/lvuru7ACV8spiSi7f/",
	"Gk7tAyObiU9pqot+U6QX+bbV56a9ez7H7KZCR5j78k1GKTsEEOW314/6hG2h02Crv4zUwe18Yf3JLqFP",
	"f/phhQ/aWPPbN2txq04+YulsLR2KQm8yxFXAE4Vea5H7QvLoNpUD/N7Kgg6bbUweuqLQeaHRypGyGcSr",
	"OIX/dqDcnwOlRtWi0C2DmfTv+B9VTtiwdLWZw+W7//eaqF3Osrnicjvd03X8cinaX6jEVJnY7QuVoAnb",
	"QAMSsmQJiJofoYZ1l1zWK8V89lkd8Wu9Z6XTys0ua9ETI4LFkEVmjopmjePCV7B3XoGye58jC4Ve2I1F",
	"hx9Oh78dD78fvv/73/YSjQiwoyx/fOt0gooiXcxjQ8CVX4cvGMdSLMPT0PPnLAOlaZYbIYeP2LvCQuXQ",
	"tvOI/FhQSbkGGy83BfLmxbNHjx59P1rvAWks5dLGo+y1EhfLsu9CzFIeHj9cx9jMSDKWpoRxI9rmEpQa",
	"kBxfeSFarqztEx+1k01wvwEtV8PTmfnQLRpYzOc2VxQfm8F3URkn9jUBVXuTVK4sE1SbKGPZTgKxbJ++",
	"4YRTW6BaIS8ChmhuIVFSZk+P3vzBN46x1W2Lm5b5AOsOFD+bzfTsBNkHyh3ZFy1kuco7S7CjaVoftgm2",
	"zrvAgdC7+z58m5Nsrv/Yx6LfeqFG/7ZBJddG5DVPV5hgUMm6HCQ5f44Pg2LF/zlTGt8uLcuIjrpYFvk6",
	"JIv8/nFcm2N/9apRj/lLldH3dZxL+OJG/l8AAAD//2NkxoTO3gAA",
}
