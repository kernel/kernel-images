...
var swaggerSpec = []string{
	...
	"wk/5ClKR7+sGeYvJB7YrKTUVLYzOVAsO6iSe98dSbgXRDVLhywXSWAplPQpGMKGBwbGWDbwckXcKrCXq",
	"JVV6iDMPz547e3/h3OpGADrOdAKJKZsbYE2G/bnz2y8wNtndwiWEOpujBTIcNjVnHOG9i7pXJWL5Xn3K",
	"3la7WU/pAqbKjLLa7410gJ2V02q1rtOBiw2VHKivMwTzi1gCcLUU+g0sdsmF3s2/9rP1q5V5cQtn7NmQ",
	"RdbjcfkNPS37DLRj9IUd6565dubDFObmlJMcbhSPsceYQZe3h8LAA3Ybyg7xHMkS0VsSmpuEETxqm2nP",
	"+3rjU02n15sdWD8LyT4Ijkm1OBehmSi4HhEbhrMC970iGD07IBwWtPG9wUNYQ7Er2JJD93/MiuMd5k/E",
	"FQ9MX+ThyW8ScVImXu/uvNjGFVTbOgS17PDmVPszxd5D7hwG0kmZ31NqsSQBviUu2IarVL5A12lrLINr",
	"17PsFyyFc5AZs+VoDlv/QooiDxsY8ScXcinJTw0rzb6xvYFc9u8ePz7aL3VdXPGQP8usFX9CD5Zf77ue",
	"9e4SB3q1FAptIB621m1tPaQYOpAcmla+IS63XoNhz6QcWiioR+kLiXY5iA3vJ6WPZE8nS93jj8UXQj6W",
	"ej5EIzhuvJUp65MHAWJUmGYNq8PuYGW0gE+3s0WTPFTISZra3DFFnPD21haXaYSeeGvixCDaq1ZxMPyb",
	"C3vJY4qYq36w8MkhdbI+9YHmhfqN6vhWiyiUFS7QIoTFZsLJHkamsRVsN92XgtCNR8q+6XqHcK7e4DSE",
	"wA1LMcwlzSAcfPWmUvt9I0P989wIsxVIyRJQPgvRQeCozg4Px9v8AEGruKfUgD27pttbZrilghC4aM/r",
	"Z/zC8na/77laR9336mNwN0NnI0Ayeo25CewDnPFXP/avAHlQuYyKVz/uiJF2fv6DHYOrLrTIb0poQsZg",
	"xtnOL2dZBgmjGtI1FnDEe7YoNFlIGsO8SIlaFtooiCPy1tyoMwwRRLMp4xjjImWRG8G0YgkIBFbY5bVP",
	"JRLLwWZBd1iGpF2eZ+9LwM2KWBgVWUtxCSqYeB50vYWT4w8KyvbRItU6fFB6LTibkjm7Nke62clowhv5",
	"x7IAcl8ZBYgqjJbGcPzjxJcgORqRC4yir6IZJ9yFnxG9zs1caNahnAgviWrzNSBF7uN3/zE2cHEx40ej",
	"Ca8VQ8AKawZq6xwSA/YrIZOhYdzEGmhdPFO5c8a1pEPTyk6oJpzyhHCqC2mEItcg7c+5UXmUzUq1a7PJ",
	"32YtG1A34eHM72DJOEOKCFeseWUN1kuBMXO2WltPWpCYGiUxhs20eA5yGC+ppLE2zLXOBWHccAKW2qQa",
	"fiAZU5pe+jKjQkqbSYUwm9H4UuU0hooIyHhEXvN0bfNpQIUgQO4rlgLX6boBpwmvmiFtHFlQlcJzPHoQ",
	"pHrvE9y1XN67PKEabkOpe2EVNi1IgWN6DLWqlo7uTgn7TTINZbHCw4TWZspreP58Sp6f8NCahaYZc3ZR",
	"zKWOnka/YJo8OcvoAhQ5OT+LBtEKpC0bG41HD0ZjvIHlwGnOoqfRo9F49MglpOFGjn1g9vE8pQuvYsYB",
	"HfMVyAVgkDW2tOQM10yhd0xwUAOP0taggdDuFaNEFTnIFVNCJgMrMDBZvOCapQi5svVzWL0VIlVkEqVM",
	"aeCMLyYRJoCljIOhfjFzhQZmMBfSZy2j1uVyEJAxDA6twpTgBUzHSz/LC9y/RQUo/aNI1ntVtm6pDh6a",
	"Lb+K35KFoRYkQ7C6LNo/JtFweMmEurTxv8NhwpQRscNFXkyi90eHh+zaBYXJqmpnZI2N2q/qrT8cjwOW",
	"Aly/xXeCpQPKrTlkt3OpPw2ix3akEP+WMx63y7t/GkRPdunXrI2OhcKLLKNybY5sS5flElNa8HjpkGAW",
	"79aM3SrqzUXK4uri1c8VhQI59KUzq2kA6w1JpoDgUGtSabyl73BGy59HhqoGE76VXcj+3DLh+7LLM5BY",
	"IspDgWSU04UNfrf1OQjjc0mVlkWMshupmJz6ch0XoI1sUIMJz6W4Xg+xhpC5j7sR7T7K8T0Z4tXp2fPz",
	"Y5/mJ/gRnqWzVMSXkEw4OqY8LLdy9rlH4+HMHT4aQtrhLsgfkV98UoX7idMM1ITfd6H7TjN4JsQlA+Xg",
	"OImOEF5YlsHZtpblCPbb0YRfABBflAMpGaqVjBZCLFIoCfvY2pzKxCP/vSvJYlMXbKF9xeKTQi9fr0D+",
	"rHV+imF6iYdBcMF4XzSN1bt8IWkCquzlDtVX9PqZ4NxqT+oc5Lmhk+jpo4eD6FzkRa5O0lRcQfJCyHcy",
	"VWhd7RYcid5/ui255mnlmxVtbbLDcve9Eq7IU0GTYVlhRw0pT4a+rRF7QgUUnXfYDesKC0kyI0HKIcgH",
	"lhMq4yVbGQ6Ha40VxfUSMlJwcyM9XooMjq0IOa6mPp4U4/Gj2LACfoLBhCvQRBoZl9VnsHKb8QMUjVJy",
	"TvhnVDQsvErBqE548sbBeJNMyopUs5xKfTwXMhv6UI0+naMCZX/mU9XGquCIR8yIiTVbUd1IY24OHy7w",
	"8EKkBqdov9eC5CmNwRVm8ejaD+ste8TJ8Hc6/DAefj+aDt9/fDB4+ORJ2M3wgeXTOUsDS/y9Ikhf99CF",
	"8RQ8t0HhFfuUq76PJbF91lZGOZuD0nhEH9Xd8zPGDSdu0+rL5blKGaFb1kYFrobdw7S4B6HQrpIaLClA",
	"MghIO8s1JXNgXS+afGm51xFBJTZrRH6fKiOQ1FFdCJZbdNLQ2QWOZ17HC0u9U5+Qxolo1eLsPBqDNj1X",
	"Jf7k/IzENE1H5MT9iie/9Ycadab+rIwr9rgUaeJjza7jtFCGeI36MyBKEC6IQPM8RpGSUtgoElNu7S0p",
	"0BVg7a5t78qUNeY94AkrE7it99bXjscqUqMJRwOmTT2bFynqEPHScVUCNhTe3AuraCWMcraVCcxsl7C2",
	"xfwduCbcm0tzujajuCA3IkXBk6GWLCdGdeSxDcYDzNTkCVuxpKCpGyYkeQMvBN1ADdxkedjwFtGhyggO",
	"2VOa6kvyXskIG15NqtN0i81a7wh4ZmsirnpB4I7wFXii4EA02aLO/gEGz9ZfFEMXLCtSm3ljua7+xErY",
	"KNrBkTVXHRtR34+mN0CTZzXTVghat4Wu5usioafSykdC3JR4TnX45sbQNZu2VvIyZLtj5esDJ9oG++HZ",
	"NE7eEemHLaCHkj9aPV2YPr48UGLhqxFYv1mDrHcM7ICv8t2OMJrK8KM7wlD3RZCdkXMr89dqyIT4zEZG",
	"rZhiM5YyvS5vy18Nxn9mictmF1f1QllNNDdfpAlrfVikA7UWjMHzAtWWzh+UDjejuVFfnspMK7X1cA3M",
	"9LxdTn/BVr5iuVVMU6AKULeq137cUus9pPGULxfcEWl23+Y5UG6Ygb6S4xKXUpUgs2iiiIcWxSxAW4KZ",
	"lk9m9QqJn0A3ysXd5fEYrksX5l1MPrQ7LTdxG1D8CXSjmLbTPKyw8DPtonw0n3oKA7csW3dHZN59ROpG",
	"2qGDgtnZlyX1V74aWwM7/lQsYw8rSaN2wVjjea0NctSVvKrmwZAElJm12IUy8NHayasI3FrdngkPVeMZ",
	"kRcof83CJCyB23tzt+zPgCiACTeLCZfuIVRXZvQF06O5BEhAXWqRj4RcHF+b/+RSaHF8/eCB/ZCnlPFj",
	"O1gC89HSynMX3bQUXEhVD2IZprCCar/mRu1i12IHCgzgVM6EZrEgkqDHw9WSuiN26DyLdiA3IEKRWr4m",
	"bcGe8XVbEtLlDoSvyiSJflH1ll5ClUxxVxpjJyfkk8PRxhOHZXQBx7nNYapm2m7d7Bws1QIIDvpFEerz",
	"FympEOQj47ag0z31FxZiNtuFrFxGSLo22tuxMLzts1TMd7qm49UkaVNbbNj5GgXRnBrYSDdx789wkooF",
	"JqNoFl8qcp8L7VKhrImzRkFkBku6Yoak6ZqsqFz/QHSBVjr33JZnYB//NRN6WduKdTf67BfMlXG2S+fq",
	"HtQf9fDhS+jpaZg075djoCpcTXBk4z7QimQDnyB1ydROFP7p49ysAWM4dK+o/kqGQxtANibWg2AVcutD",
	"+DMkIS980skdsV/99ccDpaMjr6/EhmQXU+kKFj1UG814D23OZ/32CEcXPHpHeOk+HXkDI4cNiPxqTi18",
	"PhmNGv1YcK/gNSJYAqESrqrlXSkPgSqun9mg0XwqMXB8vXMWDP9sYCPX5CZofjz+fns/s66UxbcfF9Cz",
	"HUMaVs4eu8DLqaqem7cPV4Ye4RC5CkVr4kHBtCLPnp+TTHCmhRzUXOPW44T6rOtgy7UQWwpTkcfjx/bZ",
	"x7JBVVc2JMq1yFuv5N+l6bk5U0j3KXdlH4NHtD/ejsBfhX4hCp4Exa8WeQjWZvAF6FDui4Vl/QqOYC5r",
	"xbdCbA+F/k+gv07gUw23AvrSkNGFfE8YoOW26iXu1e1BOxR6fUdyelOU92eW17uj3Zmebyaib0gwTtj2",
	"0Uz4KqGp1CrMmCeaZOYsNzdSTyRGZcdwa6uBaZaBf2bL0NT3hqZog6RSjNLwpGVfAqNpCtK+9m4fM3Gx",
	"Oi6M23d3wU3le7AUA78F75HGnYTPu9Ky+1NLg7fdB19GDMkb0+MXURkQumEirukLruxN/x35DNNhVKBM",
	"0iIVM5rWqiUhTZbFpKpSNqSsd4P3R8ZjCVRZAm2Vv+EJmVNueokCvXs0TYnIgfsiNnEVYBq0m9VKRd2V",
	"+huoRvWZxWm3JlKAgm0hJhrHkPvI17LG0eHk3DS02fE2ldBqEFtVQSyo8rzOgVs32apRuEjMvRWhdNB3",
	"aQ/LvWOaMBY5RB1VyIz8yZKn5KOCvz5NJjyhmj4lH309qKEBu/l+MuF/jsgJUWuul6BZTP60M04TiTrg",
	"n25ol1Zuk7rcoq4A345lmBZWrtDWCPaiF9kwZVgPDM3fGMqgl5D9gJr2nyz50ww+HpGLJk+UJppW5SiD",
	"z0Tg0+oSFOgyLdBxufqB0FZlKFwb5ViKf8VEoerny4qmzMbqY/WosjKJLVpHXuDrFzXusxlDXLTmsBF5",
	"JRRKzdVvyixb8HRNFNj0o/qroe2DqKz6pzCM1GBAg1RY/LZbsjAD98YE1rhqiRb33BC+W8oTMraJtMG1",
	"emvIrqjAGD7q3le0MO5C2JbkUj6BMC0f3qK6Xo6Lmc0sgSaY12hjdKMGhKNBTUi0zbjvtwodDdfasuOw",
	"4sZblDov+3h3hEWQzMZwZf85vLg4Hbron+HbYCm5V5Aw6hI/5zgoVhV0bHe/LT+PGqDxpfY6UjZQc/BT",
	"++TEpbt5qCKuzu2FoQ5HjyjW5urYHGUapmWBfDxIi1AEHDYsSzvcVRhcc5a9zqcHmypR2H1+ReYyu1On",
	"ylbg93ixRo8d8PIcG941Xuws9ZeuDo6zKFFit/jZr0q3EaCBK68/QtnGmw/934CyFzb8/uvGFpZg+jdA",
	"FOKjxJG44qmgieGu6QeW9yp03kZCye9n57ZgSC1jw74ZguhSZW3LqlxS/d3PFv7d/M+Z/J3l21SD6iW4",
	"knMwIstcLlwaidWl7KAjfwr/VQCKA3cIu8JRTRqoHzhbC1G93+tG4OB6IyeugbrfY1lIBAmrDuBvkS4d",
	"suoixBzUltDclnvoVelkB4LVVI4+KE3uaypr6UaZD3ZA7deMdbSRrid8A2GT35VOiDD3BEXMZRmfdsay",
	"EHOqjCbrJ3RG+QlPoP6V+UylLWf7geXOCU3jJYMVvqMJuj0KslE40rDGVQZG3wpbDT52X4Uqt4sROSPy",
	"M1ssQdq/ysdlicqs/cynN5JZoYmml0BSwRcgRxM+tJhQ+in5l8G2HYI8GBBXlMMgFhJy/1+PxuPhk/GY",
	"vPrxWB2Zjq7oSLPjowGZ0ZTy2KhSpucxYoDc/9eDJ7W+FnHNrv8YeHz6Lk/Gw//V6NRZ5oMBflv2eDge",
	"Pi579GCkRi1THKahVldFr/2nqqq1A1U0qP1ml4wfVKhW+b5S0XHvjcTiW8fb/5+JRt3cdikejfya+lok",
	"Tiw2RUP5yvSuMmHrQ95fwwm7n05YvbTdJSjU8mrPeH+DZPMT6MZD5P5dmQ72SrJJmdKop6teuqneQz/s",
	"MPk2KaXadYBUqutbap003yCtYPY5Yt4mxnZpA1/Q7ru++Tef7zDU+zaubhhaXZk7vkE84Q7QoIv5/JuY",
	"WQJNykt3kJffAE3clXs3VsbJvEpoxv9auFnEGsLWzwN0CRT9wbzEb4xYMAuyvMo0bJwKrKCf1oox93J3",
	"tyb23SXV9RTfPrhaTK3W9BeKQ7gNvy/oLqPX62gfY51utWR5iWFbLqLfCYx1e3xVCXTc2loIQhJb1SQF",
	"dyA4/5+ETDgZYHMzRz1VVLx6cGtlU0qNpKfuSfXafn/9cdPGPcBcSjBXBdAptLtUHh9EXqDuW13EVRap",
	"lrp3eRELhVurLIJYKouKfOuiLlBsZO70tTo7eNPmxqJJFA0vyG/2KV1bH4lpVdk2O+lYbfrqYw5r3bw1",
	"1tiX9JN6HfJa5afy4qzFbnxQL+Zzg0o7m/jhQML+neUVWdcQ+G9D5LRewKtFoh16d8aVLQS/r2m0jy8m",
	"fDtjbDeRNiyiE94yifaX73I2zltjLm9V6eYaLKFteimPkK3MMPhyTGs+5dOK7jYXUq4eekzBqgh4cFbd",
	"bcCFZLl/98atDYtzYeltQ07DIbYZVv2OtlX6bskLj4c7ERcnDob/5iKjTa49YuOqXWArEEjqnse4ywjS",
	"1gscu+P2wGLAuO3ge8jvOPurgNCzERVXXjlwbK3E371r4jbJbdes/ELEZjdTN1K7wmN8UdPEEFrHHz3I",
	"PzXzWbppJBW5tYwUaHhwlgZndyjxuMn2sN3UEHgO1iMKQwe/dURh5grCyoaOd41HbSS5cM9eU5KNr3qh",
	"+kL77g5XtxgNh4+k4NXWvfkZiCFvhMFVd2EXWfZVB8R9g2RqHzltQ9mV8LFit6RYc5nfHGSERaZ2MXg+",
	"rylftGP8/Ix+79fVYyH+3bfeJ99I/cmS7x4/7lsmvpPWs6yND8VZ5tvlxL+hOfZAa0ZZ4uxbP0bRLGVO",
	"Th8PWYVqpWIRiLlvuejEwj2v3iOHWwThXoreRLle0DgSr+o1B5/7Dk8zF2kqrsKRB423cmtPlrXRjGHm",
	"ZRV6Nid27YQp4pa2gTH7T5V95qntPTxb1WDq4sq/XHz3S7HY8SgzhPXNhXObRWPRfjO1ZZA8pesrfGb2",
	"2JVl3aFcsJwxLalck/Oyt31PH32hc8yTqF6BRNRca0IXlHFlb+IzKa4USCILjiXJueAkFTFNl0Lpp98/",
	"fPjQpfeZUZdUYRKPQlF9L6cLuDcg99y492wx53tuyHvlK06+6oh7lMznDJsRq8Vh6WddSG4fhqpXDQ4Z",
	"ThwIqn0/s6fDXdzsOnN9oVSrwDoMQIO12Crgfo3lfastYBmNC1y5pYgAcToGsTIJuaP/ou+etTcT3Vm9",
	"qnKGL5VyV19BHwVU1bmla/NVlHWORZYZKaHWPF5KwUWhfBVnj2CV0yu+FcMX2OpOUYxTfFkcuyX0IRl/",
	"/sLFfLq4pRuQ+9F9wLv5JWtWxAoi+heGpZW238urkTeqhKUmXxQsucll4SCEmt18lZV3X//yTcYXGFHC",
	"FuamqYVPh9xAcRIU+wBbae6NbfZvQ3V2P/9Nd7cXoISPDVNy/vafw5l9GmQ78SlNddFvivQi37b63LR3",
	"x+eY3VToCHO/fJNRyg4BRPnt9aM+YTvoNNjq30bq4Ha+sP5kl9CnP/24xqdorPntm7W4VScfsXS2kQ5F",
	"obcZ4irgiUJvtMh9IXl0k8oBfm9lQYftNiYPXVHovNBo5UjZHOJ1nMJ/O1DuzoFSo2pR6JbBTPoX+I8r",
	"J2xYutrM4fLF/jtN1C5n2V4ruZ3u6Tp+uRTtL1Qcqkzs9oVK0IRtoAEJWbEERM2PUMO6Sy7rlWI++6yO",
	"+I3es9Jp5WaXteiJEcEyxiIzR0WzOnHha887r0DZvc+RhUIv7Maiww8nw9/Hw++H7//+t4NEIwLsOMsf",
	"3zidoKJIF/PYEHDlr8MXjGMpluFJ6OFyloHSNMuNkMNKRdayWw1tO4/ITwWVlGuw8XIzIG9ePHv06NH3",
	"o80ekMZSLmw8ykErcbEshy7ELOXh+OEmxmZGkrE0JYwb0baQoNSA5Pg+C9FybW2f+BydbIL7DWi5Hp7M",
	"zQ/dcn/FYmFzRfGZGHzRlHFi3wFQtddE5doyQbWJMpbtQSCW7dM3nHBqS0sr5EXAEM0dJErK7OnRmz/4",
	"xjG2umlZ0jIfYNOB4mezmZ6dIPtAuSP7FoUsV3lrCXY0TevDNsHWedE3EHp314dvc5LtlRv7WPRbL7Ho",
	"XyWo5NqIvObpGhMMKlmXgyRnz/FJT6zVv2BK46ujZQHQURfLIt+EZJHfPY5rcxyuXjUqKX+pAvi+AnMJ",
	"X9zI/wsAAP//cXs5d53eAAA=",
}
