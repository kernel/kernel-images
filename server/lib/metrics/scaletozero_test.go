...
func TestResponseDrainCollector(t *testing.T) {
	...
	}, func() int64 { return 3 }, func() int64 { return 1 }, func() int64 { return 2 }, func() uint64 { return 4 })
	writer := &Writer{}
...
# HELP kernel_scale_to_zero_response_fail_closed_holds HTTP response holds awaiting terminal connection recovery or guest termination.
# TYPE kernel_scale_to_zero_response_fail_closed_holds gauge
kernel_scale_to_zero_response_fail_closed_holds 1
# HELP kernel_scale_to_zero_response_close_monitors Duplicated sockets currently monitored for acknowledged response close.
# TYPE kernel_scale_to_zero_response_close_monitors gauge
kernel_scale_to_zero_response_close_monitors 2
# HELP kernel_scale_to_zero_response_close_monitor_rejections_total Response close monitor requests rejected at the concurrency limit.
# TYPE kernel_scale_to_zero_response_close_monitor_rejections_total counter
kernel_scale_to_zero_response_close_monitor_rejections_total 4
`, string(writer.Bytes()))
}
